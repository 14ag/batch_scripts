...
if "%package%"=="" (
    ...
    cls
    set "infos=Installing all packages in the current directory..."
    call :info
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "try { Add-AppxPackage -Path '%package%' -ErrorAction Stop } catch { exit 1 }" >nul 2>&1
if errorlevel 1 (
